 ...
 */
public class Nfa<S, A> implements Fsa<S, A, Set<S>, A> {

    private final Set<A> alphabet;
    private final Set<S> states;
    private final Map<Pair<S, A>, Set<S>> transFn;
    ...
    public String toString() {
        return "NfaConcrete{" + "alphabet=" + alphabet + ", states=" + states 
    ...
    public int hashCode() {
        ...
        hash = 37 * hash + Objects.hashCode(this.states);
        hash = 37 * hash + Objects.hashCode(this.transFn);
        hash = 37 * hash + Objects.hashCode(this.initState);
    ...
    public void writeTo(PrintWriter writer) {
        ...
        transFn.forEach((trigger, ssj) -> {
            writer.printf("%s %s ", trigger._1, trigger._2);
